# NTRG GMP WIN32 -- Makefile
# Patroklos G. Argyroudis <argp@cs.tcd.ie>
#
# Makefile for compilation of GMP on Win32.
#
# $Id: Makefile,v 1.1.1.1 2004/01/11 10:29:39 argp Exp $

CC = cl
CFLAGS = -nologo -D_NTRG_WIN32_ -DHAS_STRING_H -D__STDC__ -DOPERATION_trunc
